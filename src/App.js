...
function App() {
  ...
  const chat=useRef([[],[["咦, 你過嚟搵我做咩呀?", "唉, Stack Undarflow嘅真相... 其實一開始都真係唔關我事...", "但係一講起, 又諗起返組媽,", "而一諗起就唔開心...",
    ...
    "我好掛住組媽, 而我真係好想返返轉頭...", "意外之後, 我同呀P都努力緊起港大一間實險房嘗試整啲嘢返轉頭...", "一路我遇上好多好多挫拆, 我覺得世界好唔公平, 自己好辛苦...",
    "去到有次我就嚟成功... 我只係行開咗幾日去咗科大研究啲嘢...", "你哋Stack Undarflow嘅組爸就入咗個實驗房整欄咗我部機... 我嗰陣真係好崩潰...", "你哋組爸嗰時應該忙住搞CSA個Superpass, 都唔知佢無啦啦嚟搞我做咩...",
    "嗰時呀P又成日拍拖又唔幫我...", "不過就係咁, 我識咗呀A, 佢叫我繼續努力, 唔好放棄...", "佢又同我講Stack Undarflow嘅嘢, 我先發覺原來Stack Undarflow 好勁, 可以好快connect 到好多港大學生,",
  ...
  ["咦, 你過嚟搵我做咩呀?", "嘩, 呢份秘密文件, 你哋點解會有嘅...", "唉, 一直都唔想講, 但係既然你都睇咗, 咁就大家都知我嘅秘密, 我都唔使再收收埋埋...",
    ...
    "第一次嘅時候, 我係成功用部穿梭機連咗個穿梭門嚟到呢個宇宙嘅香港,", "我覺得香港好靚, 就諗住帶組媽嚟香港拍拖...",
  ...
  [["咦, 你過嚟搵我做咩呀?", "Stack Undarflow 嘅真相... 咁我而家係Stack Undarflow 内部團隊之一, 我的確係知多少少嘅...", "咁其實Stack Undarflow就一直都好好哋嘅, 但係你哋組爸Undar就一直都好古怪.",
    ...
    "過咗陣, 佢先好似知咩事咁, 就話自己穿梭咗去加拿大要搭返飛機返嚟...", "咁嗰時我就即刻問佢穿梭機嘅科技, 佢就叫我唔好同其他人講, 咁我都應承咗佢...",
    ...
    "然後Undar就話我哋揼咗佢一哋重要嘢, 就再整唔返部穿梭機...", "佢當時我灰心, 先至唔再搞Stack Undarflow...",
  ...
  ["咦, 你過嚟搵我做咩呀?", "唉呢場意外... 我都唔係幾想講...", "當時我個中同Glisson無啦啦跳海, 我真係畀佢嚇親... 呢件事仲搞到Undar畀警察拉咗去拘留...",
    ...
    "同埋就算關事, 我都唔知點解佢會覺得呢度海底會無啦啦有啲高能量嘅嘅...", "其實我哋由中一開始就識, 都識七年... 佢無啦啦跳海走咗, 我都唔開心...", "咁不過都過咗喇, 事係可惜嘅, 但係大家都move on咗就算喇...", ""
  ...
  ["咦, 你過嚟搵我做咩呀?", "嘩, 明明冇人知呢件事你都揾到嘅...", "咁好啦, 雖然有啲恐怖, 我都講下啦...", "咁2022年頭香港爆第五波, 我唔小心中咗招, 就去咗竹篙灣隔離...",
    ...
    "我原本諗住叫埋Pilot走, 不過佢竟然早我一步已經跑咗出間屋等緊我...", "我仲以為佢拗柴會走唔到, 但係佢都幾勁喎... 早我咁多出嚟...", "嗰時佢問我間屋仲有冇人, 咁平時都淨係得我同佢兩個就梗係再冇其他人啦...",
  ...
  function returnbagitem(n) {
    if (n==="遊戲說明卡") {
      return(<>
        ...
        {checkbag2===4 ? <><div id="bgnote"><div className="fullop">角色介紹: (2/3)<br></br>
    ...
    if (n==="劇本") {
      return(<>
        ...
        {checkbag2===3 ? <><div id="bgnote"><div className="fullop">Cθnfidεntial: (3/7)<br></br>
          ...
          我就夠膽當場同你表白... 然後妳直接黑面拒絕我 :(... 我真係好唔開心, 嗰晚我喊咗成晚, 搵咗P同Z兩日後陪我訴苦... 點解好似我咁耐嘅努力你一直都睇唔到 :((
            </div></div></> : <></>}
  ...
  return (
    <div className="App">
      ...
      <div className="header-right"><h1>⠀UCM series</h1></div>
      <button className="mutebutton" style={{"backgroundImage":"url(./img/"+(muted ? "soundoff" : "soundon")+".gif)"}} onClick={() => {
        if (muted) {bgmm.current.play(); smuted(false); console.log("play");} else {bgmm.current.pause(); smuted(true); console.log("pause");}
      }}></button>
