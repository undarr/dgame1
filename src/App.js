...
function App() {
  ...
  [["咦, 你過嚟搵我做咩呀?", "Stack Undarflow嘅真相? 咪當年呀U沉船整咗嚿嘢出嚟拯救全體Engine學生囉~", "我嗰時參加咗Stack Undarflow嘅Interest Group, 同組爸一齊去踩單車先知佢嘅故事,",
    "聽佢講佢當年沉船嘅故事佢都沉到幾癲, 而佢沉得嚟又真係幫到好多人...", "但係佢沉船沉極都唔夠我癲㗎啦, 因為我真係沉咗架船~",
    "我中六12月有次學校假期同班frd去香港仔玩, 當時我有兩個朋友有遊艇牌, 我哋就租咗兩架遊艇嚟玩,", "上咗遊艇之後, 我哋就決定環繞香港島兜一個圈... 去到中環嗰陣, 我個friend有啲攰, 就想畀我試吓揸架遊艇...",
    "咁我不嬲好大膽㗎, 就真係走咗去試... 而唔講笑我一開始都揸得幾好...", "不過後來我嚟到呢度附近就想試下加速, 就失手直接炒埋去我第二個frd架遊艇度...", "我都唔知咩事, 撞嗰吓明明好輕力, 但係就突然間成㗎遊艇著曬火...",
    "嗰吓真係好驚, 我同我啲friend即刻跳船游去第二架游艇避難,", "游到第二架遊艇嘅時候, 原本嗰架遊艇已經沉咗一半...", "然後過咗陣就連架船都見唔到, 唔講笑真係好誇張...",
