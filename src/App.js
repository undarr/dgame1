...
function App() {
  ...
  [["咦, 你過嚟搵我做咩呀?", "唉, Stack Undarflow嘅真相...", "其實Stack Undarflow嘅故事一開始都好單純, 但係後來真係複雜好多...", "可能我畀啲背景大家先...",
    ...
    "*呀P show咗幾幅相你睇...", "直到2023年4月我喺度開始拍拖, 我就決定咗留低, 唔再翻去...", "但係之後組爸上CSA莊就出咗件事, 呀U先開始接任Stack Undarflow...",
  ...
  [["咦, 你過嚟搵我做咩呀?", "Stack Undarflow 嘅真相... 咁我而家係Stack Undarflow 内部團隊之一, 我的確係知多少少嘅...", "咁其實Stack Undarflow就一直都好好哋嘅, 但係你哋組爸Undar就一直都好古怪.",
    ...
    "然後Undar就話我哋揼咗佢一啲重要嘢, 就再整唔返部穿梭機...", "佢當時我灰心, 先至唔再搞Stack Undarflow...",
  ...
  ["咦, 你過嚟搵我做咩呀?", "唉呢場意外... 我都唔係幾想講...", "當時我個中同Glisson無啦啦跳海, 我真係畀佢嚇親... 呢件事仲搞到Undar畀警察拉咗去拘留...",
    ...
    "同埋就算關事, 我都唔知點解佢會覺得呢度海底會無啦啦有啲高能量嘅嘢...", "其實我哋由中一開始就識, 都識七年... 佢無啦啦跳海走咗, 我都唔開心...", "咁不過都過咗喇, 事係可惜嘅, 但係大家都move on咗就算喇...", "⠀"
    ...
    if (n==="遊戲說明卡") {
      return(<>
        ...
        {checkbag2===2 ? <><div id="bgnote"><div className="fullop">遊戲預告片:<br></br>
          <iframe id="trailer" src="https://www.youtube.com/embed/RI-nUVenGjw?si=FxPSQ6Ruw6tgi2Xe"></iframe>
          </div></div></> : <></>}
  ...
  return (
    <div className="App">
      ...
      <FadeInOut show={frame>=1} duration={1000}>
      <div className="frame">
        {vtodisctext.current==="*呀P show咗幾幅相你睇..." ? <img style={{"position":"absolute", "left":"min(18vw,36vh)", "width":"min(45vw,90vh)"}} src={"./img/ppic.png"} alt="" /> : <></>}
